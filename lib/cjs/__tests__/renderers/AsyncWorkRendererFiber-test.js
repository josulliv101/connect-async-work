...
var store = {
  getState: function getState() {
    return { asyncwork: { work: {}, loadState: {} } };
  },
...
var work = [{ key: 'foo', work: function work() {
...
var Enhanced1 = (0, _withAsyncWork2.default)(work)(MockCmp1);

function App() {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(Enhanced1, { store: store })
  );
}

describe('<AsyncWorkRenderer />', function () {

  describe('Rendering', function () {

    describe('to Promises', function () {
