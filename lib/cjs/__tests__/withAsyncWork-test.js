...
describe('withAsyncWork HOC', function () {
  ...
  var foo = 'foo data';
  var bar = null;
  var foo123 = 'foo123 created by fn';

  var context = {
    store: { getState: function getState() {
        return { asyncwork: { work: { foo: foo, bar: bar, foo123: foo123 }, loadState: {} } };
  ...
  describe('Props', function () {
    ...
    it('correctly passes the work keys on to <Enhanced/>', function () {
      var Enhanced = (0, _withAsyncWork2.default)(workResolved)(function (_ref) {
        var keys = _ref.keys;
    ...
    it('correctly indicates that work has not been initialized', function () {
      ...
      (0, _expect2.default)(cmp.props().workInitialized).toBe(false);
    });

    it('correctly indicates that work has been initialized', function () {
      ...
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(Enhanced, null), { context: context });
      var cmp = wrapper.find(_AsyncWork2.default);
      (0, _expect2.default)(cmp.props().workInitialized).toBe(true);
    });
  ...
  describe('Render', function () {
    ...
    it('has custom props passed down to Wrapped Component', function () {
      ...
      var Enhanced = (0, _withAsyncWork2.default)([/* no work */])(function (props) {
        return _react2.default.createElement(
          'div',
          null,
          props.customProp
